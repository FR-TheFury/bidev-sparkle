        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
          {services.map((service, index) => {
            ...
            return (
              <div
                key={service.title}
                className="relative bg-card border border-border rounded-3xl p-8 shadow-elegant hover:shadow-2xl transition-all duration-500 group hover:-translate-y-2 overflow-hidden animate-slide-up"
